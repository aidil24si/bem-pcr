    ...
    <div className="space-y-12 max-w-6xl mx-auto px-4 py-8">
          ...
          <Card className="border-gray-200 bg-white shadow-sm">
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#E6F3F7] border border-[#CCE7EF] rounded-lg">
                  <Compass className="h-5 w-5 text-[#004B5F]" />
                </div>
                <h4 className="font-bold text-[#004B5F]">Prinsip Kerja BEM</h4>
              </div>
              <ul className="space-y-2 text-xs text-slate-600">
                <li className="flex items-start gap-2">
                  <span className="text-[#004B5F] font-bold">•</span>
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-1">
            <h3 className="text-xl font-bold text-[#004B5F] flex items-center gap-2">
              <Sparkles className="h-5 w-5 text-[#004B5F]" />
              Arsip & Filosofi Kabinet
            </h3>
            <p className="text-xs text-slate-500">Pilih periode kepengurusan untuk melihat visi-misi kabinet sejarah.</p>
          </div>
          <div className="flex bg-slate-50 p-1.5 rounded-xl border border-gray-200 max-w-sm">
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                  selectedPeriod === k.periode
                    ? 'bg-[#004B5F] text-white shadow-md shadow-[#004B5F]/20'
                    : 'text-slate-500 hover:text-[#004B5F]'
                }`}
              >
                Periode {k.periode}
              </button>
        ...
        {/* Kabinet Details */}
        <div className="rounded-2xl border border-gray-200 bg-white p-8 space-y-6 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
            <div className="space-y-1.5">
              <p className="text-xs uppercase tracking-widest text-[#004B5F] font-extrabold">Filosofi & Tagline</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          <Card className="h-full border-gray-200 bg-slate-50 p-6 flex flex-col justify-between shadow-sm">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-[#E6F3F7] border border-[#CCE7EF]">
                  <BookOpen className="h-6 w-6 text-[#004B5F]" />
                </div>
                <h3 className="font-extrabold text-[#004B5F] text-xl">Visi Kabinet</h3>
              </div>
              <p className="text-slate-600 leading-relaxed text-sm italic border-l-4 border-[#004B5F] pl-4">
                &ldquo;{activeCabinet.visi}&rdquo;
              </p>
            </div>
            <div className="mt-8 pt-4 border-t border-gray-200 text-xs text-[#004B5F] font-bold">
          ...
          <Card className="border-gray-200 bg-white shadow-sm h-full">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-[#004B5F] text-xl">Misi Kabinet</CardTitle>
              </div>
            ...
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {activeCabinet.misi.map((m, index) => (
                <div key={index} className="p-4 rounded-xl border border-gray-200 bg-slate-50 hover:border-[#004B5F]/30 transition-all">
                  <span className="text-[10px] font-extrabold text-[#004B5F] uppercase tracking-widest block mb-1">Misi 0{index + 1}</span>
                  <h4 className="font-bold text-[#004B5F] text-sm mb-1">{m.title}</h4>
