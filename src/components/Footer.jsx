...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#004B5F] py-10 mt-0">
            ...
            <ul className="space-y-2 text-xs">
              {FOOTER_LINKS.map(({ path, label }) => (
                <li key={path}>
                  <button
                    ...
                    className="text-[#CCE7EF] hover:text-white transition-colors cursor-pointer text-left"
                  >
                    {label}
                  </button>
                </li>
              ...
              <li>
                <button
                  ...
                  className="text-[#CCE7EF] hover:text-white transition-colors cursor-pointer text-left font-bold"
                >
                  Portal Admin
                </button>
              </li>
